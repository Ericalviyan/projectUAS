    ...
    <div class="mx-auto">
        ...
        <div class="card">
            <div class="card-header">
                Input Checklist Kebersihan Toilet
            </div>
            <div class="card-body">
                <?php
                if ($error) {
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="toilet_id" class="col-sm-2 col-form-label">Nomor Toilet</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="toilet_id" name="toilet_id" value="<?php echo $toilet_id ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="kloset" class="col-sm-2 col-form-label">Kondisi Kloset</label>
                        <div class="col-sm-10">
                            <select class="form-control" name="kloset" id="kloset">
                                <option value="">- Input Kondisi -</option>
                    ...
                    <div class="mb-3 row">
                        <label for="wastafel" class="col-sm-2 col-form-label">Kondisi Wastafel</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="lantai" class="col-sm-2 col-form-label">Kondisi Lantai</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="dinding" class="col-sm-2 col-form-label">Kondisi Dinding</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="kaca" class="col-sm-2 col-form-label">Kondisi Kaca</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="bau" class="col-sm-2 col-form-label">Kondisi Bau</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="sabun" class="col-sm-2 col-form-label">Kondisi Sabun</label>
                        <div class="col-sm-10">
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    ...
                                    <a href="home.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Apakah yakin Delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
